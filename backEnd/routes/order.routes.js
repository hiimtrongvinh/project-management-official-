...
const { checkOrderAccess, checkProjectAccess, checkProjectEstimationAccess, checkProjectStepActionAccess } = require('../middleware/accessGuard');
...
router.post('/', checkProjectStepActionAccess(2), OrderController.createOrder);
