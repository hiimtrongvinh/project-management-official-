...
('PRJ01', 'Lắp đặt hạ tầng mạng - Regina Miracle Factory',
  ...
  'Hạ tầng mạng', 'KH001', '2026-05-05', '2026-05-20', 4, 'Triển khai lắp đặt', 75, 1),
('PRJ02', 'Nâng cấp Camera giám sát - Samsung Electronics',
  ...
  'An ninh giám sát', 'KH005', '2026-03-01', '2026-04-30', 5, 'Bàn giao và nghiệm thu', 93, 1),
...
('PRJ04', 'Hệ thống ELV & Camera - LG Display Hải Phòng',
  ...
  'An ninh giám sát', 'KH004', '2026-03-15', '2026-05-10', 2, 'Mua thiết bị và lập báo giá', 8, 1),
('PRJ05', 'Bảo trì định kỳ Server - Haengsung Electronics',
  ...
  'Bảo trì hệ thống', 'KH003', '2026-02-01', '2026-05-05', 3, 'Xác nhận thỏa thuận', 50, 1),
...
('T06', 'PRJ01', 4, 'Lắp đặt tủ Rack và Patch Panel',
...
('T13', 'PRJ05', 3, 'Lập hợp đồng bảo trì năm 2026',
...
('T18', 'PRJ06', 5, 'Nghiệm thu và bàn giao hệ thống',
